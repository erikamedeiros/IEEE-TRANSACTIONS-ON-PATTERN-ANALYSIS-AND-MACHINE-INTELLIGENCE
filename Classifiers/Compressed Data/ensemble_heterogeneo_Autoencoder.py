...
plot_confusion_matrix(best_ensemble_heterogeneo, x_teste_MC_ensemble, y_teste_MC_ensemble)
plt.show()

#Dados de treino
print ("Média da acurácia do ENSEMBLE nos dados AUTOENCODER de treino {:.4f}%.".format(mean(results_ensemble)*100))
